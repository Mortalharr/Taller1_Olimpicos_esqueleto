...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("2. Nombre de un atleta");
	...
	{		
		String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");
		Atleta atletas1 = calculadora.buscarAtleta(nombre_atleta);
		
		Pais pais1 = calculadora.buscarPais(nombre_atleta);
		...
		{
			System.out.println(" - El pais del atleta es: " + pais1.darNombre() + " --> " + nombre_atleta);
		}
	}
	*/
	...
	{		
		...
		{
			System.out.println(" - El pais del atleta es: " + pais + " --> " + nombre_atleta);
		}
